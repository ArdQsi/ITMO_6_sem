...
public class ChangeEmailTest {
    ...
    @Test
    public void changeEmailWithErrorPassword() throws InterruptedException {
        ...
        profile.click();
        WebElement change = driver.findElement(By.xpath("//a[contains(text(),'Изменить адрес электронной почты')]"));
        change.click();
        WebElement loginput = driver.findElement(By.xpath("/html/body/div/div[5]/div[1]/form/table/tbody/tr[1]/td[2]/input"));
        loginput.sendKeys("roman_kravets_den@mail.ru");
        WebElement inputPassword = driver.findElement(By.xpath("/html/body/div/div[5]/div[1]/form/table/tbody/tr[2]/td[2]/input"));
        inputPassword.sendKeys("1");
        WebElement save = driver.findElement(By.xpath("/html/body/div/div[5]/div[1]/form/table/tbody/tr[3]/td[1]/input"));
        save.click();
